<template>
	<view class="content">
		<view @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}" :style='{"backgroundColor":"rgba(102, 102, 153, 1)","height":"200rpx"}'>
			...
			<view v-if="tableName=='bianji'" class="userinfo">
				<view class="face" :style='{"width":"88rpx","boxShadow":"0 0 16rpx rgba(0,0,0,.3)","borderRadius":"100%","height":"88rpx"}'>
					<image :src="user.zhaopian?user.zhaopian:'/static/center/face.jpeg'"></image>
				</view>
				<view class="info">
					<view class="username" :style='{"boxShadow":"0 0 16rpx rgba(255,255,255,0)","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","borderRadius":"8rpx","color":"rgba(255, 255, 204, 1)","textAlign":"left","borderWidth":"0","width":"240rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.bianjizhanghao}}</view>
				</view>
			</view>
